...
class ConfigWindow(QtWidgets.QDialog):
    ...
    def initUI(self):
        ...
        if ConfigFile.settings["bL1bDefaultCal"]==3:
        ...
        l1bqcSublabel4 = QtWidgets.QLabel("<a href=\"https://oceancolor.gsfc.nasa.gov/registration/\">Register here</a>", self)
        ...
        CalHBox3.addWidget(self.ClassCalRadioButton)
        VBox2.addLayout(CalHBox3)

        
        CalHBox4 = QtWidgets.QHBoxLayout()
        CalHBox4.addWidget(self.FullCalRadioButton)
        CalHBox4.addWidget(self.FullCalDirButton)
        ...
        l1bqcGetAncHBox2 = QtWidgets.QHBoxLayout()
        # l1bqcGetAncHBox2.addWidget(l1bqcGetAncLabel2)
        l1bqcGetAncHBox2.addWidget(self.l1bqcGetAncCheckBox2)
        l1bqcGetAncHBox1 = QtWidgets.QHBoxLayout()
        # l1bqcGetAncHBox1.addWidget(l1bqcGetAncLabel1)
        l1bqcGetAncHBox1.addWidget(self.l1bqcGetAncCheckBox1)
        l1bqcGetAncHBox1.addWidget(l1bqcSublabel4)
        VBox2.addLayout(l1bqcGetAncHBox2)
    ...
    def l1bClassCalRadioButtonClicked(self):
        ...
        self.ClassCalRadioButton.setChecked(True)
        self.FullCalRadioButton.setChecked(False)
        ConfigFile.settings["bL1bDefaultCal"] = 2
        
    def l1bFullCalRadioButtonClicked(self):
        print("ConfigWindow - l1b Calibration set to Full")
        self.DefaultCalRadioButton.setChecked(False)
        self.ClassCalRadioButton.setChecked(False)
        self.FullCalRadioButton.setChecked(True)
        ConfigFile.settings["bL1bDefaultCal"] = 3
