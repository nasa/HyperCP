...
class ProcessL1aDALEC:
    ...
    def processL1a(fp, calibrationMap):
        ...
        for i in [0,1,2]:
            ...
            #add cal coefficients as group attributes
    ...
    def read_cal(inputfile):
        ...
        data = pd.read_csv(inputfile, skiprows=flag_data, nrows=200, names=data_hdr)
    ...
    def read_data(inputfile):
        ...
        data = pd.read_csv(inputfile, skiprows=flag_data+2, names=data_hdr)
