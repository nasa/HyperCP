...
Uncertainties in Li, Lt, and Es are estimated using the standard deviation of spectra in the ensemble or full-file average. Uncertainty in Rho_sky is estimated at +/- 0.003 from Ruddick et al. 2006 Appendix 2; intended for clear skies. Uncertainty in Rrs and nLw are estimated using sum of squares propagation of uncertainties from Li, Lt, Es, and Rho_sky assuming random, uncorrelated error. So, e.g.: Rrs_unc = Rrs * ( (Li_sd/Li)^2 + (Rho_sky_Delta/Rho_sky)^2 + (Li_sd/Li)^2 + (Es_sd/Es)^2 )^0.5
